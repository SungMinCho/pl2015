...
Proof with auto.
  ...
  Case "T_If".
    ...
    SCase "t1 can take a step".
      ...
      left; eauto.
      inversion H;subst...
      right; exists (tsucc x)...
  Case "T_Pred".
    inversion IHHT.
    inversion H.
    inversion H0; subst; inversion HT.
    right. inversion H0;subst... exists tzero; eauto.
    exists t; eauto. inversion H;subst.
    right; eexists. eauto.
  Case "T_Iszero".
    inversion IHHT.
    inversion H.
    inversion H0; subst; inversion HT.
    right. inversion H0;subst... eexists; eauto.
    eexists; eauto. inversion H;subst.
    right; eexists. eauto.
Qed.
